...
function setup() {
    cnv = createCanvas(CANVAS_WIDTH, window.innerHeight);
...
function updatePos(e) {
    ...
    let r = bezier_ramp(0.0, 0.0, 0.3, 0.8, 1.0, 1.0, 0.005);
    e[0] = e[0] + r * e[2].x;
    e[1] = e[1] + r * e[2].y;
}
...
function draw() {
    ...
    for (let e of ellipses) {
        let shape_size = ramp(0.0, 4.0, 0.03) + 1.5;
        ...
        let is_outside_vertical_bounds = e[1] < 0 || e[1] > window.innerHeight;
